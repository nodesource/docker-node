...
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 1bf343cdebd0
 ---> 2bf0a03786b2
Removing intermediate container 1bf343cdebd0
...
Get:8 http://security.debian.org wheezy/updates/main amd64 Packages [461 kB]
Get:9 http://httpredir.debian.org wheezy-updates/main amd64 Packages [7481 B]
Fetched 8490 kB in 1s (4674 kB/s)
...
Get:4 http://security.debian.org/ wheezy/updates/main libldap-2.4-2 amd64 2.4.31-2+deb7u1 [242 kB]
Get:5 http://httpredir.debian.org/debian/ wheezy/main libncursesw5 amd64 5.9-10 [141 kB]
Get:6 http://security.debian.org/ wheezy/updates/main libexpat1 amd64 2.1.0-1+deb7u3 [139 kB]
Get:7 http://security.debian.org/ wheezy/updates/main openssh-client amd64 1:6.0p1-4+deb7u4 [1025 kB]
Get:8 http://httpredir.debian.org/debian/ wheezy/main libbsd0 amd64 0.4.2-1 [59.3 kB]
Get:9 http://security.debian.org/ wheezy/updates/main libc-dev-bin amd64 2.13-38+deb7u10 [228 kB]
...
Get:19 http://httpredir.debian.org/debian/ wheezy/main libkrb5-3 amd64 1.10.1+dfsg-5+deb7u7 [394 kB]
Get:20 http://httpredir.debian.org/debian/ wheezy/main libkeyutils1 amd64 1.5.5-3+deb7u1 [8664 B]
...
Get:23 http://httpredir.debian.org/debian/ wheezy/main libgssapi-krb5-2 amd64 1.10.1+dfsg-5+deb7u7 [150 kB]
Get:24 http://httpredir.debian.org/debian/ wheezy/main libsasl2-2 amd64 2.1.25.dfsg1-6+deb7u1 [120 kB]
...
Get:35 http://httpredir.debian.org/debian/ wheezy/main libmpfr4 amd64 3.1.0-5 [538 kB]
...
Get:42 http://httpredir.debian.org/debian/ wheezy/main perl amd64 5.14.2-21+deb7u3 [4429 kB]
...
Get:59 http://httpredir.debian.org/debian/ wheezy/main g++ amd64 4:4.7.2-1 [1374 B]
...
[0mFetched 79.1 MB in 7s (11.0 MB/s)
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> b5a9787293b8
Removing intermediate container 6747636461ec
Successfully built b5a9787293b8
...
Cleaning up list of fastest mirrors
 ---> 7fdeb1e78e44
Removing intermediate container 07260023a08b
Successfully built 7fdeb1e78e44
...
Step 1 : FROM debian:jessie
 ---> bb5d89f9b6cb
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 6442722615fd
 ---> 90bad5ec7203
Removing intermediate container 6442722615fd
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in b461fe6a264e
...
Get:5 http://security.debian.org jessie/updates/main amd64 Packages [312 kB]
...
Fetched 9712 kB in 2s (4169 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
Get:5 http://security.debian.org/ jessie/updates/main libexpat1 amd64 2.1.0-6+deb8u2 [79.4 kB]
Get:6 http://httpredir.debian.org/debian/ jessie/main libbsd0 amd64 0.7.0-2 [67.9 kB]
Get:7 http://security.debian.org/ jessie/updates/main openssh-client amd64 1:6.7p1-5+deb8u2 [691 kB]
Get:8 http://security.debian.org/ jessie/updates/main openssl amd64 1.0.1k-3+deb8u5 [677 kB]
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 82.6 MB in 12s (6550 kB/s)
Selecting previously unselected package libgdbm3:amd64.
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> 96a3bbcb8577
Removing intermediate container b461fe6a264e
Successfully built 96a3bbcb8577
...
Step 1 : FROM ubuntu:precise
 ---> 2bffcdf4b693
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in b7ed9fc1d2c3
 ---> 820c3491fee5
Removing intermediate container b7ed9fc1d2c3
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 7bd7eea375ef
...
Fetched 29.7 MB in 11s (2504 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 70.4 MB in 17s (3998 kB/s)
...
ldconfig deferred processing now taking place
 ---> 2dd862627139
Removing intermediate container 7bd7eea375ef
Successfully built 2dd862627139
...
Step 1 : FROM centos:5
 ---> 505999341f87
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 257fa2ce2fa0
 ---> d7fa4a82e1d9
Removing intermediate container 257fa2ce2fa0
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in e42ec592f60c
...
[91mwarning: [0m[91mrpmts_HdrFromFdno: Header V3 DSA signature: NOKEY, key ID e8562897
...
Cleaning up list of fastest mirrors
 ---> 6ee3e419bbd1
Removing intermediate container e42ec592f60c
Step 4 : RUN rpm -ivh http://dl.fedoraproject.org/pub/epel/5/x86_64/epel-release-5-4.noarch.rpm  && yum install -y python26 git && yum clean all
 ---> Running in ac65c371f6ac
[91mwarning: /var/tmp/rpm-xfer.tHUOph: Header V3 DSA signature: NOKEY, key ID 217521f6
...
Cleaning up list of fastest mirrors
 ---> fe9d2bf575ec
Removing intermediate container ac65c371f6ac
Step 5 : ENV PYTHON python2.6
 ---> Running in 1a3e3dde1463
 ---> 367403ff15c5
Removing intermediate container 1a3e3dde1463
Successfully built 367403ff15c5
...
Step 1 : FROM ubuntu:trusty
 ---> 90d5884b1ee0
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 4eef627fbb4b
 ---> 296d748fa8fa
Removing intermediate container 4eef627fbb4b
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 925bb4c2ed2e
...
Fetched 21.8 MB in 7s (2764 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
[0mFetched 63.2 MB in 20s (3101 kB/s)
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> 6a65591f76d8
Removing intermediate container 925bb4c2ed2e
Successfully built 6a65591f76d8
...
Step 1 : FROM debian:sid
 ---> ccb8283a7d13
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 6c54007e9241
 ---> 21cee34dde04
Removing intermediate container 6c54007e9241
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 5cf029619cf2
...
Fetched 9717 kB in 1s (6090 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
...
Get:1 http://mirrors.accretive-networks.net/debian sid/main amd64 perl-base amd64 5.22.2-1 [1284 kB]
Get:4 http://mirrors.accretive-networks.net/debian sid/main amd64 libc6 amd64 2.22-9 [2659 kB]
...
Get:12 http://mirrors.kernel.org/debian sid/main amd64 mime-support all 3.60 [36.7 kB]
...
Get:22 http://mirrors.kernel.org/debian sid/main amd64 python3.5-minimal amd64 3.5.1-12 [1632 kB]
...
Get:29 http://mirrors.kernel.org/debian sid/main amd64 python3 amd64 3.5.1-3 [21.6 kB]
...
Get:40 http://mirrors.accretive-networks.net/debian sid/main amd64 libidn11 amd64 1.32-3 [113 kB]
...
Get:59 http://mirrors.accretive-networks.net/debian sid/main amd64 binutils amd64 2.26-9 [3667 kB]
Get:60 http://mirrors.accretive-networks.net/debian sid/main amd64 libc-dev-bin amd64 2.22-9 [250 kB]
Get:61 http://mirrors.kernel.org/debian sid/main amd64 linux-libc-dev amd64 4.5.4-1 [1124 kB]
Get:62 http://mirrors.accretive-networks.net/debian sid/main amd64 libc6-dev amd64 2.22-9 [2157 kB]
Get:66 http://mirrors.kernel.org/debian sid/main amd64 libcc1-0 amd64 6.1.1-3 [30.6 kB]
Get:68 http://mirrors.kernel.org/debian sid/main amd64 libitm1 amd64 6.1.1-3 [27.3 kB]
...
Get:65 http://mirrors.accretive-networks.net/debian sid/main amd64 cpp amd64 4:5.3.1-2 [18.2 kB]
...
Get:91 http://mirrors.accretive-networks.net/debian sid/main amd64 distro-info-data all 0.29 [5308 B]
...
Get:84 http://mirrors.kernel.org/debian sid/main amd64 libdpkg-perl all 1.18.7 [1183 kB]
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 135 MB in 6s (19.8 MB/s)
...
[0m ---> 17e5999d1233
Removing intermediate container 5cf029619cf2
Successfully built 17e5999d1233
...
Step 1 : FROM centos:6
 ---> ae6154bcd445
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 5450e05554a1
 ---> cc8626233727
Removing intermediate container 5450e05554a1
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in 4084bfca85f3
Loaded plugins: fastestmirror
Setting up Install Process
...
Cleaning up Everything
 ---> b88e3a0ff786
Removing intermediate container 4084bfca85f3
Successfully built b88e3a0ff786
...
Step 1 : FROM fedora:20
 ---> 19be29911e3e
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 03fcc009c64d
 ---> 8c91394e1c0e
Removing intermediate container 03fcc009c64d
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in 76ca236c9e22
...
Cleaning up everything
 ---> 583c8995df2e
Removing intermediate container 76ca236c9e22
Successfully built 583c8995df2e
...
Step 1 : FROM ubuntu:vivid
 ---> d1b55fd07600
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 0c310f870378
 ---> e56af72e05df
Removing intermediate container 0c310f870378
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 8b35ae42bccc
...
Fetched 21.6 MB in 6s (3114 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 77.1 MB in 44s (1748 kB/s)
Selecting previously unselected package libexpat1:amd64.
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> 7d4781f5d94e
Removing intermediate container 8b35ae42bccc
Successfully built 7d4781f5d94e
...
Step 1 : FROM fedora:21
 ---> c3f52f068a13
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 97136931285b
 ---> b3c05c96a3ba
Removing intermediate container 97136931285b
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in fb4e65c27429
...
Cleaning up everything
 ---> f03aef1e3df4
Removing intermediate container fb4e65c27429
Successfully built f03aef1e3df4
...
Step 1 : FROM fedora:22
 ---> 8b5cf972e254
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 9726bb42ee94
 ---> 6034e48944e2
Removing intermediate container 9726bb42ee94
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in 3d253a451df8
...
[0mLast metadata expiration check performed 0:00:11 ago on Thu May 19 20:15:31 2016.
...
Cleaning up Everything
 ---> 904797084f22
Removing intermediate container 3d253a451df8
Successfully built 904797084f22
