...
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 8d4868abfed1
 ---> 93bbdc6a116d
Removing intermediate container 8d4868abfed1
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in a006e73b72cd
Loaded plugins: fastestmirror
Determining fastest mirrors
 * base: mirror.web-ster.com
 * extras: mirrors.kernel.org
 * libselinux: centos.unixheads.org
...
Cleaning up list of fastest mirrors
 ---> fe493a84d991
Removing intermediate container a006e73b72cd
Step 4 : RUN rpm -ivh http://dl.fedoraproject.org/pub/epel/5/x86_64/epel-release-5-4.noarch.rpm  && yum install -y python26 git && yum clean all
 ---> Running in 7af488f4fe5e
[91mwarning: /var/tmp/rpm-xfer.JiMgo0: Header V3 DSA signature: NOKEY, key ID 217521f6
...
Cleaning up list of fastest mirrors
 ---> d5e7aac0f417
Removing intermediate container 7af488f4fe5e
Step 5 : ENV PYTHON python2.6
 ---> Running in 2c238a179263
 ---> 4e9c40a5c05a
Removing intermediate container 2c238a179263
Successfully built 4e9c40a5c05a
...
Step 1 : FROM ubuntu:precise
 ---> 2bffcdf4b693
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 4da6a16284f7
 ---> a3f33d20c7a9
Removing intermediate container 4da6a16284f7
...
Fetched 29.7 MB in 7s (3862 kB/s)
...
[0mFetched 70.4 MB in 16s (4294 kB/s)
...
ldconfig deferred processing now taking place
 ---> d484a5d25331
Removing intermediate container e9f782934a8b
Successfully built d484a5d25331
...
Step 1 : FROM centos:6
 ---> ae6154bcd445
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 083deb5a5913
 ---> eb7490c6095e
Removing intermediate container 083deb5a5913
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in 520369a52353
Loaded plugins: fastestmirror
Setting up Install Process
...
Cleaning up Everything
 ---> 7065e04541b2
Removing intermediate container 520369a52353
Successfully built 7065e04541b2
...
Step 1 : FROM debian:jessie
 ---> bb5d89f9b6cb
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 7a0b0bbbb6dc
 ---> ed18f6503232
Removing intermediate container 7a0b0bbbb6dc
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 2dc6a50e90cc
...
Fetched 9712 kB in 2s (4020 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
Get:10 http://security.debian.org/ jessie/updates/main libtasn1-6 amd64 4.2-3+deb8u2 [49.0 kB]
Get:11 http://httpredir.debian.org/debian/ jessie/main libgnutls-deb0-28 amd64 3.3.8-6+deb8u3 [694 kB]
Get:12 http://security.debian.org/ jessie/updates/main libidn11 amd64 1.29-1+deb8u1 [136 kB]
Get:13 http://httpredir.debian.org/debian/ jessie/main libkeyutils1 amd64 1.5.9-5+b1 [12.0 kB]
Get:14 http://security.debian.org/ jessie/updates/main libexpat1 amd64 2.1.0-6+deb8u2 [79.4 kB]
Get:15 http://httpredir.debian.org/debian/ jessie/main libkrb5support0 amd64 1.12.1+dfsg-19+deb8u2 [59.1 kB]
Get:16 http://security.debian.org/ jessie/updates/main openssh-client amd64 1:6.7p1-5+deb8u2 [691 kB]
...
Get:20 http://security.debian.org/ jessie/updates/main openssl amd64 1.0.1k-3+deb8u5 [677 kB]
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 82.6 MB in 8s (10.2 MB/s)
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> ffc2a15cec7b
Removing intermediate container 2dc6a50e90cc
Successfully built ffc2a15cec7b
...
Step 1 : FROM debian:wheezy
 ---> 2e9c7e5da19c
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 782d05c9d74c
 ---> ee4b7e53930e
Removing intermediate container 782d05c9d74c
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 78317d33b324
...
Fetched 8490 kB in 1s (4342 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
Get:8 http://security.debian.org/ wheezy/updates/main libc-dev-bin amd64 2.13-38+deb7u10 [228 kB]
Get:9 http://httpredir.debian.org/debian/ wheezy/main libbsd0 amd64 0.4.2-1 [59.3 kB]
Get:10 http://security.debian.org/ wheezy/updates/main libc6-dev amd64 2.13-38+deb7u10 [2663 kB]
Get:11 http://httpredir.debian.org/debian/ wheezy/main libedit2 amd64 2.11-20080614-5 [72.9 kB]
Get:12 http://httpredir.debian.org/debian/ wheezy/main libgpg-error0 amd64 1.10-3.1 [77.9 kB]
Get:13 http://security.debian.org/ wheezy/updates/main openssl amd64 1.0.1e-2+deb7u21 [702 kB]
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 79.1 MB in 32s (2401 kB/s)
Selecting previously unselected package libgdbm3:amd64.
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> ea9f7abb5561
Removing intermediate container 78317d33b324
Successfully built ea9f7abb5561
...
Step 1 : FROM debian:sid
 ---> ccb8283a7d13
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 48f957f7dc4b
 ---> 987c4a382b58
Removing intermediate container 48f957f7dc4b
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in cc4bd413b20c
...
Fetched 9718 kB in 2s (4091 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 135 MB in 6s (20.4 MB/s)
...
[0m ---> f70fab568a15
Removing intermediate container cc4bd413b20c
Successfully built f70fab568a15
...
Step 1 : FROM fedora:20
 ---> 19be29911e3e
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 668c0354e3ca
 ---> 2614178d113c
Removing intermediate container 668c0354e3ca
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in be94057913ef
...
Cleaning up everything
 ---> 99ee354057d7
Removing intermediate container be94057913ef
Successfully built 99ee354057d7
...
Step 1 : FROM ubuntu:trusty
 ---> 90d5884b1ee0
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in fd020f9e2066
 ---> f21afc01bd65
Removing intermediate container fd020f9e2066
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in 1c21006caca7
...
Fetched 21.8 MB in 12s (1792 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
[0mFetched 63.2 MB in 34s (1823 kB/s)
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> d45592688e94
Removing intermediate container 1c21006caca7
Successfully built d45592688e94
...
Step 1 : FROM ubuntu:vivid
 ---> d1b55fd07600
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 06b12181264d
 ---> f48f2ca42800
Removing intermediate container 06b12181264d
Step 3 : RUN apt-get update  && apt-get install -y --force-yes --no-install-recommends      apt-transport-https       ssh-client       build-essential       curl       ca-certificates       git       libicu-dev       lsb-release       python-all       rlwrap  && rm -rf /var/lib/apt/lists/*;
 ---> Running in fad504c6f096
...
Fetched 21.6 MB in 11s (1924 kB/s)
Reading package lists...
Reading package lists...
Building dependency tree...
Reading state information...
...
[91mdebconf: delaying package configuration, since apt-utils is not installed
[0mFetched 77.1 MB in 42s (1822 kB/s)
Selecting previously unselected package libexpat1:amd64.
...
Running hooks in /etc/ca-certificates/update.d....done.
 ---> 20fab00ff7ab
Removing intermediate container fad504c6f096
Successfully built 20fab00ff7ab
...
Step 1 : FROM fedora:21
 ---> c3f52f068a13
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 4446a8cdc915
 ---> 12d85f289318
Removing intermediate container 4446a8cdc915
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in cb00727585eb
...
Cleaning up everything
 ---> dc684c330d59
Removing intermediate container cb00727585eb
Successfully built dc684c330d59
...
Step 1 : FROM fedora:22
 ---> 8b5cf972e254
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 66d4c74c5d9c
 ---> 5753b9260404
Removing intermediate container 66d4c74c5d9c
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in 8ccdeaee47ed
...
[0mLast metadata expiration check performed 0:00:14 ago on Fri May 20 17:16:23 2016.
...
Cleaning up Everything
 ---> ed80f181262a
Removing intermediate container 8ccdeaee47ed
Successfully built ed80f181262a
...
Step 1 : FROM centos:7
 ---> 8596123a638e
Step 2 : MAINTAINER William Blankenship <wblankenship@nodesource.com>
 ---> Running in 815e4ac4f86e
 ---> 2f3b792ed2a5
Removing intermediate container 815e4ac4f86e
Step 3 : RUN yum install -y       automake       libicu       curl       gcc       gcc-c++       git       kernel-devel       make       perl       which  && yum clean all
 ---> Running in ebc0fadedeb2
...
Cleaning up list of fastest mirrors
 ---> b34126911ac0
Removing intermediate container ebc0fadedeb2
Successfully built b34126911ac0
